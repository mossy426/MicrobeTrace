...
1. Run npm i angular-cli-ghpages --save-dev (Only if you dont already have it. This will install globally)
2. Run an npm install to get node modules if not done yet.
...
5. Run npx ngh --dir dist/Microbetrace
6. Updates will be visible in 5-10 minutes.
